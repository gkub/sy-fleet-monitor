...
//
// Covers uptime calculations, upload-duration averages, edge cases,
// duplicate heartbeat buckets, and duration formatting.
...
func TestCalculateAverageUploadDuration(t *testing.T) {
	var testCases = []struct {
		...
		},
		{
			...
			// 197331667813 ns formats as 3m17.331667813s.
